...
- **Avançado clone:** rastreia até 18 páginas e 80 assets internos do mesmo domínio base e subdomínios autorizados, reescreve links locais e gera um ZIP real.
...
> Importante: o crawler é limitado ao mesmo domínio base e subdomínios autorizados, bloqueia endereços privados, limita páginas/assets/tamanho e só inicia com confirmação de autorização. Sites com login, bloqueio anti-bot ou conteúdo renderizado exclusivamente por JavaScript podem não ser exportados integralmente. Use apenas em sites próprios ou com autorização expressa.
